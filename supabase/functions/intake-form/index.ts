...
const allowedFields = new Set([
  ...
  "work_impact", "sexual_wellbeing_impact", "safety_concerns", "contact_safety", "coping_responses",
  "support_network", "partner_support", "partner_support_details",
  "previous_therapy", "health_information", "medication",
